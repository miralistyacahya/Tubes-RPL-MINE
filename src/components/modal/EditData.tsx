...
function EditData<T>({
  ...
  return (
    <div className="p-2 flex justify-center ">
      <button
        className="btn-neutral btn-info btn-sm space-x-4"
        ...
        <div className="modal-box bg-white">
          <div className="modal-header">
            ...
            <form
              ...
              className={!isValid ? "group-invalid" : "group"}
            >
              {fields &&
                fields.map((field) => (
                        ...
                        <input
                          ...
                          pattern={
                            field.key === "price" || field.key === "stock"
                              ? "\\d+"
                              : undefined
                          } // Set pattern only for 'price' and 'stock'
                          placeholder={field.label}
                          className={
                            !field.readOnly
                              ? "input w-full focus:ring-2 ring-blue-500 input-bordered bg-white font-regular text-zinc-500 ... peer invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500"
                              : "input w-full input-bordered bg-gray-100 font-regular text-zinc-500 "
                          }
                        />
                        {(field.key === "price" || field.key === "stock") && (
